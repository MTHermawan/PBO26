...
public class Main {
    ...
    private void LihatDetailProyek(int id) {
        ...
        System.out.println("———————————————————————————————————————————");
        System.out.println("Klasifikasi: " + p.GetKlasifikasi());
        System.out.println("Harga: " + p.GetHarga());

        if (p instanceof Games g) {
            System.out.println("Genre: " + g.GetGenreString());
        } else if (p instanceof Tools t) {
            System.out.println("Kategori Tools: " + t.getToolsKategori());
        } else if (p instanceof AddOns ao) {
            System.out.println("Add Ons untuk " + ao.GetTargetApps());
        }
