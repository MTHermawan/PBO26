...
public class Main {
    ...
    private void UploadProyek() {
        ...
        switch (_klasifikasiProyek) {
            case "Games":
                Games g = new Games(_namaProyek, _klasifikasiProyek, _hargaProyek);
                if (g.InputAtributSpesial()) {
                    dataProyek.add(g);
                }
                break;
            case "Add Ons":
                AddOns ao = new AddOns(_namaProyek, _klasifikasiProyek, _hargaProyek);
                if (ao.InputAtributSpesial()) {
                    dataProyek.add(ao);
                }
                break;
            case "Tools":
    ...
    private void EditProyek(int id) {
        ...
        do {
            ...
            for (Proyek findProyek : dataProyek) {
                if (findProyek.GetNama().equals(p.GetNama())) {
                    continue;
                }
